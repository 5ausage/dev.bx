...
<div class="container-fluid text-left">
	<div class="row justify-content-center align-items-start" style="padding-top: 128px; background: #F2F2F2;">
		<div class="col-md-5" style="max-width: 707px;">
			<h1 style="font-weight: 700; font-size: 48px; line-height: 140%;">Feature that is amazing</h1>
			<p class="text3" style="margin-top: 61px; font-weight: 500;
			 font-size: 20px; line-height: 28px; color: #000000;">Lorem ipsum dolor sit amet, consectetur adipiscing
			...
			<button class="btn col-4" style="background: #F2C94C; margin-left: 15px;
			 margin-top: 78px; max-width: 310px; height: 64px; color: #000000;
			 font-weight: 500; font-size: 18px; line-height: 21px;">Buy</button>
			<div style="margin-bottom: 110px; margin-top: 0"></div>
		</div>
		<div class="col-md-3">
			<img src="assets/moto4.png" class="img-fluid" alt="moto" style="display: block;
...
<div class="container-fluid text-left" style="margin-top: 150px;">
	...
	<div class="row justify-content-center">
		...
		<div class="col-8">
			<h1 style="margin-left: 56px; font-weight: 700; color: #000000;
			 font-size: 48px; line-height: 140%;">Value Propositipon</h1>
			<table class="table table-bordered" style="max-width: 1173px;
			 margin-top: 19px; margin-left: 56px">
			...
			<button class="btn col-4" style="background: #F2C94C; margin-left: 56px;
			 margin-top: 78px; max-width: 310px; height: 64px; color: #000000;
			 font-weight: 500; font-size: 18px; line-height: 21px;">Buy</button>
		</div>
	</div>
